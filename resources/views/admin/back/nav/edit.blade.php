...
@parent
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ _route('admin:nav.index') }}">导航管理 - 导航</a></li>
...
@section('content')
          ...
          @endif
              ...
              <h2 class="page-header">修改导航</h2>
              <form method="post" id="edit-nav-form" action="{{ _route('admin:nav.update', $Nav->id) }}" accept-charset="utf-8">
              {!! method_field('put') !!}
              {!! csrf_field() !!}
              <div class="nav-tabs-custom">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li class="tab_2"><a href="#tab_2" data-toggle="tab" aria-expanded="true">车型配置</a></li>
                  </ul>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          @foreach ($topNav as $n)
                            <option value="{{ $n->id }}" {{ ($n->id == $Nav->p_id ) ? 'selected':'' }}>{{ $n->name }}</option>
                          @endforeach
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" autocomplete="off" value="{{ $Nav->name }}" placeholder="导航名称" maxlength="20">
                      </div>
                      <div class="form-group" style="display:none;">
                        ...
                        <input type="text" class="form-control" name="slug" placeholder="导航别名" maxlength="20" value="{{ $Nav->slug }}">
                      </div>
                      <div class="form-group" style="display:none;">
                    ...
                    <button type="submit" id="edit-nav" class="btn btn-primary">修改导航</button>
...
<script type="text/javascript">
   ...
   $("#edit-nav").click(function(event){
      event.preventDefault();
      var zTreeObj = $.fn.zTree.getZTreeObj("treeDemo");
      //选中的节点
      var checkedNodes = zTreeObj.getCheckedNodes();
      $.ajax({//编辑车型配置
          url:"/admin/nav/ajaxEdit",
          type:"post",
          data:{checkedNodes:checkedNodes,navId:{{$Nav->id}}},
          dataType:"json",
          success:function(data){
            console.log(data);
            if(data.code == 200){
              $("#edit-nav-form").submit();
              return true;
            }else{
              alert(data.msg);
              return false;
