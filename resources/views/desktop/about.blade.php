...
<div class="w-1000 clearfix">
    ...
    <div class="main right">
		...
		<section>
			<h3>可以用手机访问吗</h3>
			<p>目前已是琅环网第三次大改版，采用最新的H5技术，可在电脑、平板、手机等各种设备上使用，并且兼容苹果、安卓、windows操作系统，目前提供网页版，后续我们将推出苹果和安卓客户端</p>
			<p><img src="/Public/Home/img/public/heade-rwm.png" title="手机扫描二维码访问本站" width="150px"/></p>
		</section>
		<section>
			<h3>你们是哪里的</h3>
