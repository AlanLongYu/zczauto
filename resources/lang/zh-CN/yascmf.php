...
return [
    ...
    */
    ...
    'intro' => [
        ...
        'source'    => '基础版源码',
        'donation'  => '打赏捐助',
        'qr_text'   => '<blockquote><p>开源项目离不开各位朋友的支持，如果您觉得 <code>YASCMF</code> 系列软件/源码还不错，可以考虑打赏几元支持一下作者我。打赏捐助的钱会用于服务器和相关网站的运营。</p></blockquote><p>使用支付宝或微信手机客户端扫描下面对应的二维码捐赠：</p><p><img alt="wechat_alipay" src="/assets/wechat_alipay.jpg"></p><p>所有打赏捐助记录会公布在官网和文档源码仓库中。</p>',
    ],
    'feature' => [
        'thanks' => [
        ...
        'advantages' => [
            ...
            'paragraph' => '支持同一源码多站绑定，路由限制；前台已提供多语言切换功能；后台也提供了更加细致的权控；前台会员用户与后台管理用户多表认证不冲突。',
        ],
        'ui' => [
            'heading'   => '响应式开源的后台管理模版<br>搭配多种前端组件',
            'paragraph' => '后台管理模版基于 <span>AdminLTE</span> ， 来自 <a href="https://www.almsaeedstudio.com/">Almsaeed Studio</a> ，开源免费，搭配多种前端组件，多套主题完美适配，让你快速上手，完成后端代码逻辑。',
        ],
    ],
    'social_contact' => [
        'text' => '与YASCMF开发者联系：',
